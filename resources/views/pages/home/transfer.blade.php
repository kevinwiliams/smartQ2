<x-base-layout>
    ...
    <div class="card">
        ...
        <div class="card-body p-3">
            ...
            <div class="stepper stepper-links d-flex flex-column pt-15" id="mv_create_token_stepper">
                ...
                <!--end::Nav-->
                <!--begin::Form-->
                <form class="mx-auto mw-600px w-100 pt-15 pb-10" novalidate="novalidate" id="mv_create_token_form" action='{{ URL::to("home/tokenTransfer") }}' method="post">
                    <!--begin::Step 1-->
    ...
    @section('scripts')
    @include('pages.home._client-transfer-token-js')
    <script>
        var chart;
        var lastLat;
        var lastLng;
        ...
        $(function() {
            ...
            $('#mv_location_list').on('change', function(e) {
                ...
                var visitreason = obj.data('visitreason');
