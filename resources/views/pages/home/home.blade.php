    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="card-px text-center pt-5 pb-5">
                ...
                <!--begin::Title-->
                <h2 class="fs-2x fw-bolder mb-0 p-5">Welcome to </h2><br><img alt="Logo" src="{{ asset(theme()->getMediaUrlPath() . 'logos/waitwise-logo.png') }}" class="img-fluid mh-85px" />
                <!--end::Title-->
                <!--begin::Description-->
                ...
                <a href="{{theme()->getPageUrl("home/list")}}" class="btn btn-dark er fs-6 px-8 py-4 px-2 my-2">View my token</a>
                @elseif(count(auth()->user()->clientpendingtokens) > 1)
                <a href="{{theme()->getPageUrl("home/list")}}" class="btn btn-dark er fs-6 px-8 py-4 px-2 my-2">View my tokens</a>
                @endif                
