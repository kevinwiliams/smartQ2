                                    ...
                                    <div class="col">
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-body d-flex flex-center flex-column pt-12 p-3">
                                                ...
                                                <!--end::Avatar-->
                                                <!--begin::Name-->
                                                <a href="{{theme()->getPageUrl('apps/user-management/customers/view/' . $officer->id)}}" class="fs-4 text-gray-800 text-hover-primary fw-bolder mb-0">{{ $officer->lastname. ', '.$officer->firstname}}</a>
                                                <!--end::Name-->
                                                <!--begin::Position-->
                                                <div class="fw-bold text-gray-400 mb-6">User </div>
                                                <!--end::Position-->
                                                <!--begin::Info-->
                                                ...
                                                <table width="90%">
                                                    <tr>
                                                        <td>
                                                            <div class="fs-6 fw-bolder text-gray-700">Last Visit</div>
                                                        </td>
                                                        <td>
                                                            <div class="fw-bold text-gray-400">{{($officer->lasttoken)? Carbon\Carbon::parse($officer->lasttoken->updated_at)->toFormattedDateString():''}}</div>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                            <div class="fs-6 fw-bolder text-gray-700">Contact</div>
                                                        </td>
                                                        <td>
                                                            <div class="fw-bold text-gray-400">
                                                                @php
                                                                    $array = [($officer->mobile)?'Mobile':'' , ($officer->email)?'Email':'' , ($officer->push_notifications)?'Push Message':''];
