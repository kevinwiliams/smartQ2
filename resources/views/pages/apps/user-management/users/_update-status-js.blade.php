<script>
// Class definition
var MVUsersUpdateStatus = function () {
    // Shared variables
    const element = document.getElementById('mv_modal_update_status');
    const form = element.querySelector('#mv_modal_update_status_form');
