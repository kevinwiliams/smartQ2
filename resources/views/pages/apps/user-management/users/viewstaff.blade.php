<x-base-layout>
				...
				<div class="card-body">
					...
					<div class="d-flex flex-center flex-column py-5">
						...
						<div class="symbol symbol-100px symbol-circle mb-7">
							...
							<div class=" {{($user->status == 0) ? 'bg-danger' : 'bg-success'}} position-absolute border border-4 border-white h-15px w-15px rounded-circle translate-middle start-100 top-100 ms-n3 mt-n3"></div>
						</div>
								...
								<table class="table align-middle table-row-dashed gy-5" id="mv_table_users_login_session">
									...
									<tbody class="fs-6 fw-bold text-gray-600">
										...
										<tr>
											...
											<td class="text-end">
												<button type="button" class="btn btn-icon btn-active-light-primary w-30px h-30px ms-auto" data-bs-toggle="modal" data-bs-target="#mv_modal_update_status">
													<!--begin::Svg Icon | path: icons/duotune/art/art005.svg-->
													<span class="svg-icon svg-icon-3">
														<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
															<path opacity="0.3" d="M21.4 8.35303L19.241 10.511L13.485 4.755L15.643 2.59595C16.0248 2.21423 16.5426 1.99988 17.0825 1.99988C17.6224 1.99988 18.1402 2.21423 18.522 2.59595L21.4 5.474C21.7817 5.85581 21.9962 6.37355 21.9962 6.91345C21.9962 7.45335 21.7817 7.97122 21.4 8.35303ZM3.68699 21.932L9.88699 19.865L4.13099 14.109L2.06399 20.309C1.98815 20.5354 1.97703 20.7787 2.03189 21.0111C2.08674 21.2436 2.2054 21.4561 2.37449 21.6248C2.54359 21.7934 2.75641 21.9115 2.989 21.9658C3.22158 22.0201 3.4647 22.0084 3.69099 21.932H3.68699Z" fill="black" />
	...
	{{ theme()->getView('partials/modals/users/_update-status', 
        array(
            'user' => $user			
            )) }}
	...
	@include('pages.apps.user-management.users._update-status-js')
	@endsection
</x-base-layout>