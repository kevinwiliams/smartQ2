...
<div class="timeline-item">
    ...
    <div class="timeline-content mb-10 mt-n1">
        ...
        <div class="pe-3 mb-5">
            <!--begin::Title-->
            <div class="fs-5 fw-bold mb-2">Custom screen views</div>
            <!--end::Title-->
            ...
            <div class="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-700px p-7">
                ...
                <div class="overlay me-10">
                    ...
                    <div class="overlay-wrapper">
                        <span class="badge bg-primary">{{ trans('app.custom_display') }} - {{ $name }}</span>
                    ...
                    <div class="overlay-layer bg-dark bg-opacity-10 rounded">
                        <a href="{{ url('/common/display?type=6&custom='.$key) }}" target="_blank" class="btn btn-sm btn-danger btn-shadow">Open View</a>
                    </div>
                    <!--end::Link-->
                </div>
                <!--end::Item-->
