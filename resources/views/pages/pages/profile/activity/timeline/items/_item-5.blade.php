    ...
    <div class="overflow-auto pb-5">
        <div class="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-700px p-7">
            ...
            <div class="overlay">
                <!--begin::Image-->
                <div class="overlay-wrapper">
                    <span class="badge bg-primary">Check In Code</span>

                    <img alt="img" class="rounded w-150px" src="{{ asset(theme()->getMediaUrlPath() . 'misc/qr.png') }}" />
                </div>
                <!--end::Image-->

                <!--begin::Link-->
                <div class="overlay-layer bg-dark bg-opacity-10 rounded">
                    <a href="/common/display?type=7" target="_blank" class="btn btn-sm btn-primary btn-shadow">Open View</a>
                </div>
                <!--end::Link-->
            </div>
            <!--end::Item-->
