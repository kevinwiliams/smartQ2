<x-base-layout>
        ...
        <div class="card-header border-0 pt-5">
            <h3 class="card-title align-items-start flex-column">
                <div class="d-flex align-items-center position-relative my-1 me-5">
                    ...
                    <!--end::Svg Icon-->
                    <input type="text" data-mv-blacklist-table-filter="search" class="form-control form-control-solid w-250px ps-15" placeholder="Search Clients">
                </div>
            </h3>
    ...
    {{ theme()->getView('partials/modals/blacklist/_add') }}
    <!--end::Modal - Add Alert-->
    <!--begin::Modal - Edit Alert -->
    {{ theme()->getView('partials/modals/blacklist/_edit') }}
    <!--end::Modal dialog-->
    <!--begin::Modal - View Alert -->
    {{ theme()->getView('partials/modals/blacklist/_view') }}
    <!--end::Modal dialog-->
    {{-- Inject Scripts --}}
    @section('scripts')
    {{ $dataTable->scripts() }}
    @include('pages.blacklist._button-actions-js')
