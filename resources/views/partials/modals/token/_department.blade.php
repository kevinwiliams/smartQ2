        ...
        <div class="modal-dialog modal-dialog-centered mw-650px">
            ...
            <div class="modal-content">
                ...
                <div id="output" class="hide alert alert-danger alert-dismissible fade in shadowed mb-1"></div>
                    <!--begin::Form-->
                    {{ Form::open(['url' => 'token/auto', 'class'=>'manualFrm form', 'id'=>'mv_modal_add_token_form']) }}
                    @csrf <!-- {{ csrf_field() }} -->
                        <!--begin::Input group-->
                        <div class="fv-row mb-7">
                            ...
                            <div class="form-group @error('client_mobile') has-error @enderror">
                                ...
                                <input type="text" name="client_mobile" class="form-control form-control-solid phone" placeholder="{{ trans('app.client_mobile') }}"/>  
