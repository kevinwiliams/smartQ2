<div class="modal fade" id="mv_modal_add_counter" tabindex="-1" aria-hidden="true">
    <!--begin::Modal dialog-->
    <div class="modal-dialog modal-dialog-centered mw-650px">
        ...
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <!--end::Modal title-->
                <!--begin::Close-->
                <div class="btn btn-icon btn-sm btn-active-icon-primary" data-mv-counter-modal-action="close">
            ...
            <div id="output" class="hide alert alert-danger alert-dismissible fade in shadowed mb-1"></div>
                ...
                <input type="hidden" name="location_id" id="location_id" value="{{$location->id}}">
                    ...
                    <div class="text-center pt-15">
                        <button type="reset" class="btn btn-light me-3" data-mv-counter-modal-action="cancel">Discard</button>
                        <button type="submit" class="btn btn-primary" data-mv-counter-modal-action="submit" >
