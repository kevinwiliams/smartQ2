    ...
    <div class="modal-dialog modal-dialog-centered mw-650px">
        ...
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <!--end::Modal title-->
                <!--begin::Close-->
                <div class="btn btn-icon btn-sm btn-active-icon-primary" data-kt-dept-modal-action="close">
            ...
            <div id="output" class="hide alert alert-danger alert-dismissible fade in shadowed mb-1"></div>
                <!--begin::Form-->
                {{ Form::open(['url' => 'admin/department/create', 'class'=>'manualFrm form', 'id'=>'kt_modal_add_dept_form']) }}
                @csrf <!-- {{ csrf_field() }} -->
                    <!--begin::Input group-->
                    ...
                    <div class="text-center pt-15">
                        <button type="reset" class="btn btn-light me-3" data-kt-dept-modal-action="cancel">Discard</button>
                        <button type="submit" class="btn btn-primary" data-kt-dept-modal-action="submit" >
