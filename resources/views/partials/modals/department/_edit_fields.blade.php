...
<div class="text-center pt-15">
    <button type="reset" class="btn btn-light me-3" data-kt-dept-edit-modal-action="cancel">Discard</button>
    <button type="submit" class="btn btn-primary" data-kt-dept-edit-modal-action="submit" >
