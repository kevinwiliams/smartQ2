<div class="modal fade" id="mv_modal_edit_scheduledreport" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-hidden="true">
    <!--begin::Modal dialog-->
    <div class="modal-dialog mw-1000px">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body scroll-y m-5">
                <!--begin::Stepper-->
                <div class="stepper stepper-links d-flex flex-column" id="mv_edit_scheduledreport_stepper" data-mv-stepper="true">
                    <!--begin::Nav-->
                    ...
                    <!--end::Nav-->
                    <!--begin::Form-->
                    <form class="mx-auto mw-600px w-100 py-10 fv-plugins-bootstrap5 fv-plugins-framework" novalidate="novalidate" id="mv_edit_scheduledreport_form" action="/reports/scheduled/edit" method="post">
                        <!--begin::Step 1-->
                        <div class="current" data-mv-stepper-element="content">
                            ...
                            <div class="w-100">
                                ...
                                <div class="mb-10 fv-row fv-plugins-icon-container">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Select-->
                                    <select class="form-select form-select-solid " data-control="select2" data-placeholder="Select Report" tabindex="-1" aria-hidden="true" name="report_id" id="edit_report_id">
                                        <option value=""></option>
                                        @php
                        ...
                        <div data-mv-stepper-element="content">
                            ...
                            <div class="w-100">
                                    ...
                                    <div class="row mb-2" data-mv-buttons="true" data-mv-initialized="1">
                                        ...
                                        <div class="col">
                                            ...
                                            <label class="btn btn-outline btn-outline-dashed btn-active-light-primary w-100 p-4">
                                                <input type="radio" class="btn-check" name="schedule_type" id="{{ $key }}_edit_schedule_type" value="{{ $key }}">
                                ...
                                <div class="mb-10 fv-row fv-plugins-icon-container">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input type="text" class="form-control  form-control-solid" name="start_date" id="edit_start_date" placeholder="Pick a date" value="">
                                    <!--end::Input-->
                                    <div class="fv-plugins-message-container invalid-feedback"></div>
                                </div>
                                <!--end::Input group-->
                                <div id="daily_edit_schedule_div" style="display: none;">
                                    <!--begin::Input group-->
                                    <div class="mb-10 fv-row fv-plugins-icon-container">
                                        <!--begin::Label-->
                                    ...
                                    <div class="mb-10 fv-row fv-plugins-icon-container">
                                        ...
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                        <input type="text" class="form-control  form-control-solid" name="daily_end_date" id="edit_daily_end_date" placeholder="Pick a date" value="">
                                        <!--end::Input-->
                                        <div class="fv-plugins-message-container invalid-feedback"></div>
                                    </div>
                                    <!--end::Input group-->
                                </div>
                                <div id="weekly_edit_schedule_div" style="display: none;">
                                    <!--begin::Input group-->
                                    <div class="mb-10 fv-row fv-plugins-icon-container">
                                        <!--begin::Label-->
                                        <label class="form-label mb-3">Recurs every</label>
                                    ...
                                    <div class="mb-10 fv-row fv-plugins-icon-container">
                                        ...
                                        <!--end::Label-->
                                        <!--begin::Select-->
                                        <select class="form-select form-select-solid " data-control="select2" data-placeholder="Select Weekday" tabindex="-1" aria-hidden="true" name="weekly_dayname[]" id="edit_weekly_dayname" multiple="multiple" data-close-on-select="false">
                                            <option value=""></option>
                                            @php
                                    ...
                                    <div class="mb-10 fv-row fv-plugins-icon-container">
                                        ...
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                        <input type="text" class="form-control  form-control-solid" name="weekly_end_date" id="edit_weekly_end_date" placeholder="Pick a date" value="">
                                        <!--end::Input-->
                                        <div class="fv-plugins-message-container invalid-feedback"></div>
                                    </div>
                                    <!--end::Input group-->
                                </div>
                                <div id="monthly_edit_schedule_div" style="display: none;">
                                    <!--begin::Input group-->
                                    <div class="mb-10 fv-row fv-plugins-icon-container">
                                        <!--begin::Label-->
                                        ...
                                        <!--end::Label-->
                                        <!--begin::Select-->
                                        <select class="form-select form-select-solid " data-control="select2" data-placeholder="Select Month" tabindex="-1" aria-hidden="true" name="monthly_months[]" id="edit_monthly_months" multiple="multiple" data-close-on-select="false">
                                            <option value=""></option>
                                            @php
                                    ...
                                    <div class="row">
                                        <div class="col-1">
                                            <div class="form-check form-check-custom form-check-solid mt-10">
                                                <input class="form-check-input" type="radio" value="days" id="edit_monthly_months_on1" name="monthly_months_on" checked />
                                            </div>
                                        </div>
                                        <div class="col">
                                            <!--begin::Input group-->
                                            <div class="mb-10 fv-row fv-plugins-icon-container">
                                                ...
                                                <!--end::Label-->
                                                <!--begin::Select-->
                                                <select class="form-select form-select-solid " data-control="select2" data-placeholder="Select Days" tabindex="-1" aria-hidden="true" name="monthly_days[]" id="edit_monthly_days" multiple="multiple" data-close-on-select="false">
                                                    <option value=""></option>
                                                    @php
                                                    $counter = 1;
                                                    @endphp
                                    ...
                                    <div class="row">
                                        <div class="col-1">
                                            <div class="form-check form-check-custom form-check-solid mt-10">
                                                <input class="form-check-input" type="radio" value="ordinals" id="edit_monthly_months_on2" name="monthly_months_on" />
                                            </div>
                                        </div>
                                        <div class="col">
                                            <!--begin::Input group-->
                                            <div class="mb-10 fv-row fv-plugins-icon-container">
                                                ...
                                                <!--end::Label-->
                                                <!--begin::Select-->
                                                <select class="form-select form-select-solid " data-control="select2" data-placeholder="Select Days" tabindex="-1" aria-hidden="true" name="monthly_ordinal[]" id="edit_monthly_ordinal" multiple="multiple" data-close-on-select="false">
                                                    <option value=""></option>
                                                    @php
                                        ...
                                        <div class="col">
                                            ...
                                            <div class="mb-10 fv-row fv-plugins-icon-container">
                                                ...
                                                <!--end::Label-->
                                                <!--begin::Select-->
                                                <select class="form-select form-select-solid " data-control="select2" data-placeholder="Select Days" tabindex="-1" aria-hidden="true" name="monthly_weekday[]" id="edit_monthly_weekday" multiple="multiple" data-close-on-select="false">
                                                    <option value=""></option>
                                                    @php
                                                    $weekdays = \App\Core\Data::getDayNames();
                                                    @endphp
                                    ...
                                    <div class="mb-10 fv-row fv-plugins-icon-container">
                                        ...
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                        <input type="text" class="form-control  form-control-solid" name="monthly_end_date" id="edit_monthly_end_date" placeholder="Pick a date" value="">
                                        <!--end::Input-->
                                        <div class="fv-plugins-message-container invalid-feedback"></div>
                                    </div>
                                    <!--end::Input group-->
                        ...
                        <div data-mv-stepper-element="content">
                            ...
                            <div class="w-100">
                                ...
                                <div class="fv-row mb-10 fv-plugins-icon-container">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input type="text" class="form-control  form-control-solid" name="date_range" id="edit_date_range" placeholder="Pick a date range" value="" tabindex="-1">
                                    <!--end::Input-->
                                    <div class="fv-plugins-message-container invalid-feedback"></div>
                                </div>
                                <!--end::Input group-->
                                ...
                                <div class="fv-row mb-10 fv-plugins-icon-container">
                                    ...
                                    @can('choose location')
                                    <!--begin::Select-->
                                    <select class="form-select form-select-solid " data-control="select2" data-placeholder="Select Location" tabindex="-1" aria-hidden="true" name="location_id[]" id="edit_location_id" multiple="multiple" data-close-on-select="false">
                                    ...
                                    <input type="hidden" name="location_id" id="edit_location_id" value="{{ auth()->user()->location_id }}" />
                                    <!--end::Input-->
                                    @endcan
                                    <div class="fv-plugins-message-container invalid-feedback"></div>
                                </div>
                                ...
                                <div class="fv-row mb-10">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <textarea name="notify" id="edit_notify" class="form-control  form-control-solid" rows="3"></textarea>
                                    <!--end::Input-->
                                </div>
                                <!--end::Input group-->
                            </div>
