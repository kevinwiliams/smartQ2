<div class="modal fade" id="mv_modal_edit_alert" tabindex="-1" aria-hidden="true">
    <!--begin::Modal dialog-->
    <div class="modal-dialog modal-dialog-centered mw-650px">
        ...
        <div class="modal-content">
            ...
            <div class="modal-header">
                <!--begin::Modal title-->
                <h2 class="fw-bolder">{{ trans('app.edit_alert') }}</h2>
                <!--end::Modal title-->
                <!--begin::Close-->
                <div class="btn btn-icon btn-sm btn-active-icon-primary" data-mv-alert-edit-modal-action="close">
            ...
            <div class="modal-body scroll-y mx-5 mx-xl-15 my-5">
                ...
                <!--begin::Form-->
                {{ Form::open(['url' => 'alerts/edit', 'class'=>'manualFrm form', 'id'=>'mv_modal_edit_alert_form']) }}
                @csrf
                <!-- {{ csrf_field() }} -->
                <input type="hidden" name="alert_edit_id" id="alert_edit_id" value="">
                <!--begin::Input group-->
                <div class="fv-row mb-7">
                    <div class="form-group @error('title') has-error @enderror">
                        <label for="title">{{ trans('app.title') }} <i class="text-danger">*</i></label>
                        <input type="text" name="title" id="title" class="form-control" placeholder="{{ trans('app.title') }}" value="">
                ...
                <div class="fv-row mb-7">
                    <div class="form-group @error('message') has-error @enderror">
                        ...
                        <textarea type="text" name="message" id="message" class="form-control" placeholder="{{ trans('app.message') }}"></textarea>
                    ...
                    <div class="col">
                        ...
                        <div class="fv-row mb-7">
                            <div class="form-group @error('start_date') has-error @enderror">
                                ...
                                <input type="text" name="start_date" id="edit_start_date" class="form-control datetimepicker" value="">
                    ...
                    <div class="col">
                        ...
                        <div class="fv-row mb-7">
                            <div class="form-group @error('end_date') has-error @enderror">
                                ...
                                <input type="text" name="end_date" id="edit_end_date" class="form-control datetimepicker" value="">
                ...
                <div class="image-input image-input-outline" data-mv-image-input="true" style="background-image: url('{{ asset(theme()->getMediaUrlPath() . 'icons/duotune/general/gen006.svg') }}')">
                    ...
                    <div class="image-input-wrapper w-250px h-250px" style="background-image: url('{{ asset(theme()->getMediaUrlPath() . 'icons/duotune/general/gen006.svg') }}'); "  id="alert-logo-wrapper"></div>
                ...
                @endcan
                <input type="hidden" name="locations" id="edit_locations" value="" />
                <!--begin::Input group-->
                <div class="fv-row mb-7">
                ...
                <div class="text-center pt-15">
                    <button type="reset" class="btn btn-light me-3" data-mv-alert-edit-modal-action="cancel">Discard</button>
                    <button type="submit" class="btn btn-primary" data-mv-alert-edit-modal-action="submit">
