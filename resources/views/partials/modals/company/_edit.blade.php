    ...
    <div class="modal-dialog modal-dialog-centered mw-650px">
        ...
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <!--end::Modal title-->
                <!--begin::Close-->
                <div class="btn btn-icon btn-sm btn-active-icon-primary" data-kt-company-edit-modal-action="close">
            ...
            <div class="modal-body scroll-y mx-5 mx-xl-15 my-5">
                ...
                <!--begin::Form-->
                {{ Form::open(['url' => 'admin/company/edit', 'class'=>'manualFrm form', 'id'=>'kt_modal_edit_company_form']) }}
                    @csrf <!-- {{ csrf_field() }} -->
