<div class="modal fade" id="mv_modal_add_company" tabindex="-1" aria-hidden="true">
    <!--begin::Modal dialog-->
    <div class="modal-dialog modal-dialog-centered mw-650px">
        ...
        <div class="modal-content">
            ...
            <div class="modal-header">
                <!--begin::Modal title-->
                <h2 class="fw-bolder">{{ trans('app.add_company') }}</h2>
                <!--end::Modal title-->
                <!--begin::Close-->
                <div class="btn btn-icon btn-sm btn-active-icon-primary" data-mv-company-modal-action="close">
            ...
            <div class="modal-body scroll-y mx-5 mx-xl-15 my-5">
                ...
                <!--begin::Form-->
                {{ Form::open(['url' => 'admin/company/create', 'class'=>'manualFrm form', 'id'=>'mv_modal_add_company_form']) }}
                @csrf
                <!-- {{ csrf_field() }} -->
                <!--begin::Input group-->
                ...
                <div class="text-center pt-15">
                    <button type="reset" class="btn btn-light me-3" data-mv-company-modal-action="cancel">Discard</button>
