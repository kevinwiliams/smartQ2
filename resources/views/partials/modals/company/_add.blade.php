    ...
    <div class="modal-dialog modal-dialog-centered mw-650px">
        ...
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <!--end::Modal title-->
                <!--begin::Close-->
                <div class="btn btn-icon btn-sm btn-active-icon-primary" data-kt-company-modal-action="close">
            ...
            <div id="output" class="hide alert alert-danger alert-dismissible fade in shadowed mb-1"></div>
                <!--begin::Form-->
                {{ Form::open(['url' => 'admin/company/create', 'class'=>'manualFrm form', 'id'=>'kt_modal_add_company_form']) }}
                @csrf <!-- {{ csrf_field() }} -->
                    <!--begin::Input group-->
                    ...
                    <div class="text-center pt-15">
                        ...
                        <button type="submit" class="btn btn-primary" data-kt-company-modal-action="submit" >
