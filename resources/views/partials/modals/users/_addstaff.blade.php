		...
		<div class="modal-dialog modal-dialog-centered mw-650px">
			...
			<div class="modal-content">
				...
				<div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
					<!--begin::Form-->
					{{ Form::open(['url' => 'apps/user-management/users/create', 'class'=>'transferFrm', 'id'=>'mv_modal_add_staff_form', 'enctype'=>'multipart/form-data']) }}
					<!--begin::Scroll-->
					<div class="d-flex flex-column scroll-y me-n7 pe-7" id="mv_modal_add_staff_scroll" data-mv-scroll="true" data-mv-scroll-activate="{default: false, lg: true}" data-mv-scroll-max-height="auto" data-mv-scroll-dependencies="#mv_modal_add_staff_header" data-mv-scroll-wrappers="#mv_modal_add_staff_scroll" data-mv-scroll-offset="300px">
						...
						<div class="d-flex flex-column mb-7 fv-row">
							...
							<!--end::Label-->
							<!--begin::Input-->
							<input class="form-control form-control-solid phone" placeholder="" name="phone" value="" data-inputmask="'mask': '1 (999) 999-9999'" />
							<!--end::Input-->
						</div>
						<!--end::Input group-->
						<!--begin::Input group-->
						<div class="fv-row mb-7">
							...
							<!--end::Label-->
							<!--begin::Input-->
							<select name="department" aria-label="{{ __('Select a Department') }}" data-placeholder="{{ __('Select a Department...') }}" class="form-select form-select-solid form-select-lg" id="ddlDepartment" data-control="select2" data-dropdown-parent="#mv_modal_add_staff">
						...
						<div class="fv-row mb-7">
							...
							<!--end::Label-->
							<!--begin::Input-->
							<select name="language" aria-label="{{ __('Select a Language') }}" data-placeholder="{{ __('Select a language...') }}" class="form-select form-select-solid form-select-lg" id="ddlLanguage" data-control="select2" data-dropdown-parent="#mv_modal_add_staff">
						...
						<div class="d-flex flex-column mb-7 fv-row">
							...
							<!--end::Label-->
							<!--begin::Input-->
							<select name="country" aria-label="{{ __('Select a Country') }}" data-placeholder="{{ __('Select a country...') }}" class="form-select form-select-solid form-select-lg fw-bold" id="ddlCountry" data-control="select2" data-dropdown-parent="#mv_modal_add_staff">
