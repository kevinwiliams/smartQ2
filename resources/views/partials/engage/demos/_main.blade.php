...
<div
	...
	class="bg-body"
	data-mv-drawer="true"
	data-mv-drawer-name="explore"
	data-mv-drawer-activate="true"
	data-mv-drawer-overlay="true"
	data-mv-drawer-width="{default:'350px', 'lg': '475px'}"
	data-mv-drawer-direction="{{ theme()->getOption('layout', 'engage/demos/direction') }}"
	data-mv-drawer-toggle="#mv_engage_demos_toggle"
	data-mv-drawer-close="#mv_engage_demos_close">

    <!--begin::Card-->
	<div class="card shadow-none rounded-0 w-100">
		<!--begin::Header-->
		<div class="card-header" id="mv_engage_demos_header">
			<h3 class="card-title fw-bolder text-gray-700">Explore <?php //echo theme()->getProductName()?></h3>

			<div class="card-toolbar">
				<button type="button" class="btn btn-sm btn-icon btn-active-color-primary h-40px w-40px me-n6" id="mv_engage_demos_close">
		...
		<!--begin::Body-->
		<div class="card-body" id="mv_engage_demos_body">
			<!--begin::Content-->
			<div
                id="mv_explore_scroll"
				class="scroll-y me-n5 pe-5"
				data-mv-scroll="true"
				data-mv-scroll-height="auto"
				data-mv-scroll-wrappers="#mv_engage_demos_body"
				data-mv-scroll-dependencies="#mv_engage_demos_header"
