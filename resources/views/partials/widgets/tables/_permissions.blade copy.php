	...
	<div class="card">
		...
		<div class="card-body pt-0">
			<!--begin::Table-->
			<table class="table align-middle table-row-dashed fs-6 gy-5 mb-0" id="mv_permissions_table">
				<!--begin::Table head-->
				<thead>
					<!--begin::Table row-->
				...
				<tbody class="fw-bold text-gray-600">
					<tr>
						...
						<td class="text-end">
							<!--begin::Update-->
							<button class="btn btn-icon btn-active-light-primary w-30px h-30px me-3" data-bs-toggle="modal" data-bs-target="#mv_modal_update_permission">
							...
							<!--end::Update-->
							<!--begin::Delete-->
							<button class="btn btn-icon btn-active-light-primary w-30px h-30px" data-mv-permissions-table-filter="delete_row">
		...
		<div class="modal-dialog modal-dialog-centered mw-650px">
			...
			<div class="modal-content">
				...
				<div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
					<!--begin::Form-->
					<form id="mv_modal_add_permission_form" class="form" action="#">
						<!--begin::Input group-->
						...
						<div class="fv-row mb-7">
							...
							<label class="form-check form-check-custom form-check-solid me-9">
								<input class="form-check-input" type="checkbox" value="" name="permissions_core" id="mv_permissions_core" />
	...
	<div class="modal fade" id="mv_modal_update_permission" tabindex="-1" aria-hidden="true">
		<!--begin::Modal dialog-->
		<div class="modal-dialog modal-dialog-centered mw-650px">
			<!--begin::Modal content-->
			<div class="modal-content">
				...
				<div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
					...
					<!--end::Notice-->
					<!--begin::Form-->
					<form id="mv_modal_update_permission_form" class="form" action="#">
						<!--begin::Input group-->
						<div class="fv-row mb-7">
							<!--begin::Label-->
							<label class="fs-6 fw-bold form-label mb-2">
