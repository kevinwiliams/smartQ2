...
<div class="card {{ $class }}">
    ...
    <div class="card-header border-0 pt-5">
        ...
        <div class="card-toolbar">
            <ul class="nav">
                <li class="nav-item">
                    <a class="nav-link btn btn-sm btn-color-muted btn-active btn-active-light-primary active fw-bolder px-4 me-1" data-bs-toggle="tab" href="#mv_table_widget_5_tab_1">Month</a>
                </li>

                <li class="nav-item">
                    <a class="nav-link btn btn-sm btn-color-muted btn-active btn-active-light-primary fw-bolder px-4 me-1" data-bs-toggle="tab" href="#mv_table_widget_5_tab_2">Week</a>
                </li>

                <li class="nav-item">
                    <a class="nav-link btn btn-sm btn-color-muted btn-active btn-active-light-primary fw-bolder px-4" data-bs-toggle="tab" href="#mv_table_widget_5_tab_3">Day</a>
                </li>
            </ul>
        </div>
    </div>
    ...
    <div class="card-body py-3">
        <div class="tab-content">
            @foreach($tableRows as $tableRows)
                ...
                <!--begin::Tap pane-->
                <div class="tab-pane fade {{ $activeClass }}" id="mv_table_widget_5_tab_{{ $loopIndex }}">
