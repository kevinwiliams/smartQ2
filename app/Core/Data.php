...
class Data
{
    ...
    {
        return array(
            array('id' => 1, 'group' => 'Visit Reports', 'name' => 'Hourly', 'title' => 'Visit Report - Hourly', 'status' => true, 'view' => 'partials/reports/hourly-token-report', 'reportview' => 'partials/scheduledreports/hourly-token-report', 'orientation' => 'landscape', 'pageSize' => 'A4', 'showDate' => true),
            array('id' => 2, 'group' => 'Visit Reports', 'name' => 'Daily', 'title' => 'Visit Report - Daily', 'status' => true, 'view' => 'partials/reports/daily-token-report', 'reportview' => 'partials/scheduledreports/daily-token-report', 'orientation' => 'portrait', 'pageSize' => 'A4', 'showDate' => true),
            array('id' => 3, 'group' => 'Visit Reports', 'name' => 'Weekly', 'title' => 'Visit Report - Weekly', 'status' => true, 'view' => 'partials/reports/weekly-token-report', 'reportview' => 'partials/scheduledreports/weekly-token-report', 'orientation' => 'portrait', 'pageSize' => 'A4', 'showDate' => true),
            array('id' => 4, 'group' => 'Visit Reports', 'name' => 'Monthly', 'title' => 'Visit Report - Monthly', 'status' => true, 'view' => 'partials/reports/monthly-token-report', 'reportview' => 'partials/scheduledreports/monthly-token-report', 'orientation' => 'landscape', 'pageSize' => 'A4', 'showDate' => true),
            array('id' => 5, 'group' => 'KPI Reports', 'name' => 'Wait Time', 'title' => 'KPI Report - Wait Time', 'status' => true, 'view' => 'partials/reports/wait-time-report', 'reportview' => 'partials/scheduledreports/wait-time-report', 'orientation' => 'portrait', 'pageSize' => 'A4', 'showDate' => true),
            array('id' => 6, 'group' => 'KPI Reports', 'name' => 'Service Time', 'title' => 'KPI Report - Service Time', 'status' => true, 'view' => 'partials/reports/wait-time-report', 'reportview' => 'partials/scheduledreports/wait-time-report', 'orientation' => 'portrait', 'pageSize' => 'A4', 'showDate' => true),
            array('id' => 7, 'group' => 'Stats Reports', 'name' => 'Customers Served', 'title' => 'Stats Report - Customers Served', 'status' => true, 'view' => 'partials/reports/customers-served-report', 'reportview' => 'partials/scheduledreports/customers-served-report', 'orientation' => 'portrait', 'pageSize' => 'A4', 'showDate' => true),
            array('id' => 8, 'group' => 'Stats Reports', 'name' => 'No Shows', 'title' => 'Stats Report - No Shows', 'status' => true, 'view' => 'partials/reports/customers-served-report', 'reportview' => 'partials/scheduledreports/customers-served-report', 'orientation' => 'portrait', 'pageSize' => 'A4', 'showDate' => true),
            array('id' => 9, 'group' => 'General Reports', 'name' => 'Token', 'title' => 'Token Report', 'status' => true, 'view' => 'partials/reports/token-report', 'reportview' => 'partials/scheduledreports/token-report', 'orientation' => 'portrait', 'pageSize' => 'A4', 'showDate' => true),
            array('id' => 10, 'group' => 'General Reports', 'name' => 'Performance', 'title' => 'Performance Report', 'status' => true, 'view' => 'partials/reports/performance-report', 'reportview' => 'partials/scheduledreports/performance-report', 'orientation' => 'portrait', 'pageSize' => 'A4', 'showDate' => true),
            array('id' => 11, 'group' => 'General Reports', 'name' => 'Reason for Visit', 'title' => 'Reason for Visit', 'status' => true, 'view' => 'partials/reports/reasonforvisit-report', 'reportview' => 'partials/scheduledreports/reasonforvisit-report', 'orientation' => 'portrait', 'pageSize' => 'A4', 'showDate' => true),
            array('id' => 12, 'group' => 'General Reports', 'name' => 'VIP List', 'title' => 'VIP Customers', 'status' => true, 'view' => 'partials/reports/vip-report', 'reportview' => 'partials/scheduledreports/vip-report', 'orientation' => 'portrait', 'pageSize' => 'A4', 'showDate' => false),
            array('id' => 13, 'group' => 'General Reports', 'name' => 'Blacklist', 'title' => 'Blacklist', 'status' => true, 'view' => 'partials/reports/blacklist-report', 'reportview' => 'partials/scheduledreports/blacklist-report', 'orientation' => 'portrait', 'pageSize' => 'A4', 'showDate' => false),
        );
    }
