...
class Data
{
    ...
    public static function getReportList()
    {
        return array(
            ...
            array('id' => 7, 'group' => 'Stats Reports', 'name' => 'Customers Served', 'title' => 'Stats Report - Customers Served', 'status' => true, 'view' => 'partials/reports/customers-served-report', 'reportview' => 'partials/scheduledreports/customers-served-report', 'orientation' => 'portrait', 'pageSize' => 'A4'),
